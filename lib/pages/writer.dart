...
class _WriterPage extends State<WriterPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: WriterAppBar(pageContext: context),
      body: Stack(
        children: [
          Positioned(
              left: 56,
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Row(
                        children: [Icon(Icons.check), Text('Rascunho salvo')],
                      ),
                      RaisedButton(
                        onPressed: () {},
                        child: Text(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    icon: Icon(Icons.format_align_left,
                        size: 32,
                        color:
                            alignment == 'left' ? Colors.white : Colors.black),
                    onPressed: () {
                  ...
                  IconButton(
                    ...
                    icon: Icon(Icons.format_align_right,
                        size: 32,
                        color:
                            alignment == 'right' ? Colors.white : Colors.black),
                    onPressed: () {
